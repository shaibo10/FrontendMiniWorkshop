        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <Stack tokens={{childrenGap: 20}}>
                    <label htmlFor={formData[0].id}>{formData[0].question}</label>
                    <input type="text" id={formData[0].id} name={formData[0].question}/>
                    <label htmlFor={formData[1].id}>{formData[1].question}</label>
...
const getFormModel = (questions: string[]): { question: string, answer: string, id: string }[] => {
